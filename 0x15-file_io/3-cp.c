 ...
 * @file: Represents the file buffer is storing chars for
 * Drkibugu
 * Return: Represents a pointer to the new buffer
 */
char *create_buffer(char *file)
{
	char *buffer;
 ...
 * @fd: Represents the descriptor to be closed
 */
void close_file(int fd)
{
	int c;
 ...
 * @argc: Represents the no. of arguments supplied to the programs
